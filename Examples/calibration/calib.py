...
class myExperiment(Experiment):
    ...
    def updateScreen(self):     
        ...
        # update finger pos and radius based on hardware readings during the appropriate phases
    ...
    def trial(self):
        ...
        # WAIT_RESPONSE
            ...
            trgt_rad = round(float(gTarget.radius),3)
            fing_rad = round(float(gFinger.radius),3)
